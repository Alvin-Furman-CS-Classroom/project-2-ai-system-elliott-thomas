...
# Generated by run_random_case; path for tests that verify or load the generated case init.
CASE_INIT_GENERATED_PATH = _OUTPUT_DIR / "case_init_generated.json"
...
class TestRunRandomCase(unittest.TestCase):
    ...
    def test_generates_and_runs_random_case(self):
        ...
        # Check generated case_init at module_1/output_test_files/case_init_generated.json
        self.assertTrue(
            CASE_INIT_GENERATED_PATH.exists(),
            f"case_init_generated.json should be created at {CASE_INIT_GENERATED_PATH}",
        )
        with open(CASE_INIT_GENERATED_PATH, encoding="utf-8") as f:
        ...
        for fact, value in all_facts.items():
            self.assertIn(fact, case_init_data["initial_evidence"])
            self.assertEqual(case_init_data["initial_evidence"][fact], value)
