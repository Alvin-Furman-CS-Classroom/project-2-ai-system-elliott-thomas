...
class TestRunRandomCase(unittest.TestCase):
    ...
    def test_generates_and_runs_random_case(self):
        ...
        # Check output files were created (only required outputs per proposal)
    ...
    def test_reproducible_with_same_seed(self):
        ...
        # Use return values only, don't write files
        result1 = module_1.run_random_case(RULES_PATH, _OUTPUT_DIR, seed=999)
        result2 = module_1.run_random_case(RULES_PATH, _OUTPUT_DIR, seed=999)
    ...
    def test_different_seeds_produce_different_cases(self):
        ...
        # Use return values only, don't write separate files
        result1 = module_1.run_random_case(RULES_PATH, _OUTPUT_DIR, seed=100)
        result2 = module_1.run_random_case(RULES_PATH, _OUTPUT_DIR, seed=200)
    ...
    def test_respects_kb_ratio_parameter(self):
        ...
        # Use return values only, don't write separate files
        result = module_1.run_random_case(RULES_PATH, _OUTPUT_DIR, seed=42, kb_ratio=0.3)
